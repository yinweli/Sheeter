...
type Item struct {
	...
	Count  *int32 `protobuf:"varint,1,opt,name=Count,proto3,oneof" json:"Count,omitempty"`   // 物品數量
	ItemID *int32 `protobuf:"varint,2,opt,name=ItemID,proto3,oneof" json:"ItemID,omitempty"` // 物品編號
	Type   *int32 `protobuf:"varint,3,opt,name=Type,proto3,oneof" json:"Type,omitempty"`     // 物品類型
}
...
var file_item_proto_rawDesc = []byte{
	...
	0x05, 0x48, 0x00, 0x52, 0x05, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x88, 0x01, 0x01, 0x12, 0x1b, 0x0a,
	0x06, 0x49, 0x74, 0x65, 0x6d, 0x49, 0x44, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x48, 0x01, 0x52,
	0x06, 0x49, 0x74, 0x65, 0x6d, 0x49, 0x44, 0x88, 0x01, 0x01, 0x12, 0x17, 0x0a, 0x04, 0x54, 0x79,
	0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x48, 0x02, 0x52, 0x04, 0x54, 0x79, 0x70, 0x65,
