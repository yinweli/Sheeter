...
func (x *VerifyData1) GetHide() bool {
	if x != nil && x.Hide != nil {
		return *x.Hide
	}
	return false
...
func (x *VerifyData1) GetKey() int32 {
	if x != nil && x.Key != nil {
		return *x.Key
	}
	return 0
...
type VerifyData1Storer struct {
	...
	Datas map[int32]*VerifyData1 `protobuf:"bytes,1,rep,name=Datas,proto3" json:"Datas,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *VerifyData1Storer) GetDatas() map[int32]*VerifyData1 {
	if x != nil {
		return x.Datas
	}
	return nil
...
var file_verifyData1_proto_rawDesc = []byte{
	...
	0xd6, 0x01, 0x0a, 0x0b, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x44, 0x61, 0x74, 0x61, 0x31, 0x12,
	...
	0x69, 0x66, 0x79, 0x44, 0x61, 0x74, 0x61, 0x31, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x72, 0x12, 0x40,
	...
	0x69, 0x66, 0x79, 0x44, 0x61, 0x74, 0x61, 0x31, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x72, 0x2e, 0x44,
	...
	0x65, 0x72, 0x69, 0x66, 0x79, 0x44, 0x61, 0x74, 0x61, 0x31, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75,
...
var file_verifyData1_proto_goTypes = []interface{}{
	(*VerifyData1)(nil),       // 0: sheeterProto.VerifyData1
	(*VerifyData1Storer)(nil), // 1: sheeterProto.VerifyData1Storer
	nil,                       // 2: sheeterProto.VerifyData1Storer.DatasEntry
	(*Reward)(nil),            // 3: sheeterProto.Reward
}
var file_verifyData1_proto_depIdxs = []int32{
	3, // 0: sheeterProto.VerifyData1.Reward:type_name -> sheeterProto.Reward
	2, // 1: sheeterProto.VerifyData1Storer.Datas:type_name -> sheeterProto.VerifyData1Storer.DatasEntry
	0, // 2: sheeterProto.VerifyData1Storer.DatasEntry.value:type_name -> sheeterProto.VerifyData1
