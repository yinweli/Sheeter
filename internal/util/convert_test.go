...
func TestConvert(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, []bool{true, false, true, false, true}, value2)
	value2, err = StrToBoolArray("wtf,???,wtf,???,wtf")
	assert.NotNil(t, err)
	...
	assert.NotNil(t, err)
	value5, err := StrToFloat("0.0000123456789")
	assert.Nil(t, err)
	assert.Equal(t, 0.0000123456789, value5)
	value5, err = StrToFloat("?????")
	assert.NotNil(t, err)
	value6, err := StrToFloatArray("0.00001,0.00002,0.00003")
	assert.Nil(t, err)
	assert.Equal(t, []float64{0.00001, 0.00002, 0.00003}, value6)
