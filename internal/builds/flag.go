...
const flagGenerateJson = "json"       // 旗標名稱: 是否產生json檔案
const flagGenerateProto = "proto"     // 旗標名稱: 是否產生proto檔案
...
func SetFlags(cmd *cobra.Command) *cobra.Command {
	...
	flags.Bool(flagGenerateJson, false, "generate json files")
	flags.Bool(flagGenerateProto, false, "generate proto files")
