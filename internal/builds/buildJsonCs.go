...
// json-cs讀取器模板代碼
const jsonCsReaderCode = `// generated by {{$.AppName}}, DO NOT EDIT.
...
// writeJsonCsReader 輸出json-cs讀取器, 由於quicktype對於結構命名有不一致的問題, 所以採取資料結構由quicktype執行, 而資料列表由模板執行的方式
